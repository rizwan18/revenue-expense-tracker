...
- **Properties** — track one or more investment properties: rent, expenses, net rental income, estimated equity and rental yield.
  - **Tabs** — each property page has **Summary** (headline figures and property details only), **Income/Expense** (the rental schedule and every entry) and **Bills & reminders** (bills for the property plus upcoming payments).
